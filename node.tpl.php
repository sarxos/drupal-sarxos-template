...
<div id="post-<?php print $node->nid; ?>" class="<?php print $classes ?> clear-block">
	<div class="page-header">
		...
		<p class="postmetadata">
			<span class="author"><?php print(t('posted by')) ?> <?php print($author) ?></span>, 
			<span class="date"><?php print(t('on')) ?> <?php print($postdate) ?></span>,
		</p>
		<p class="postmetadata">
			<span class="comments"><?php print($comments_link) ?> <?php print(t('comments')) ?></span>
		</p>
		<?php endif; ?>
    </div>
